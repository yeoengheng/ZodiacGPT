...
export async function POST(req: Request) {
      ...
      messages: [
        {
          role: "system",
          content:
            "You are a rephraser and always respond with a rephrased version of the input that is given to a Chinese Fortune Teller. Ensure it's always relevant to the year 2024. Always be succint and use the same words as the input.",
        },
  ...
  const rephrase = await rephraseInput(messages[length-1].content) as string 
